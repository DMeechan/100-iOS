...
class AboutViewController: UIViewController {
  ...
  func clickBug() {
    ...
    DataManager.logEvent(eventName: "clickBug")
  ...
  func clickFeedback() {
    ...
    DataManager.logEvent(eventName: "clickFeedback")
  ...
  func clickWebsite() {
    ...
    DataManager.logEvent(eventName: "clickWebsite")
  ...
  func clickTwitter() {
    ...
    DataManager.logEvent(eventName: "clickTwitter")
